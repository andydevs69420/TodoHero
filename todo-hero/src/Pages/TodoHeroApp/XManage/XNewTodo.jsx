...
const XNewTodo = ({id, onSuccess}) => {
    ...
    const onNewTodo = (e) => {
        ...
        (error) => console.log("Error transmitting data at " + NEW_TODO));
    }
            ...
            <div className="modal-dialog">
                <div className="modal-content border-0 rounded-1 shadow-sm">
                    <div className="modal-header border-0">
                        ...
                        <button type="button" className="btn-close rounded-circle" onClick={closeModal} data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
